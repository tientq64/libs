...
module.exports = {
	...
	variants: {
		...
		backgroundOpacity: ['responsive', /*'dark'*/, /*'group-hover'*/, /*'focus-within'*/, /*'hover'*/, 'focus', /*'active'*/, 'disabled'],
		...
		borderOpacity: ['responsive', /*'dark'*/, /*'group-hover'*/, /*'focus-within'*/, /*'hover'*/, 'focus', /*'active'*/, 'disabled'],
		...
		textOpacity: ['responsive', /*'dark'*/, /*'group-hover'*/, /*'focus-within'*/, /*'hover'*/, 'focus', /*'active'*/, 'disabled'],
