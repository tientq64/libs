...
function isDirectChild(path1, path2) {
...
class Repo {
	...
	_treeRes(ref) { return co(function*(){
		if (this._treeCache) return this._treeCache
		if (!ref) ref = yield this._wrapGithub('getReference', { ref: this.branch })
